...
namespace War
{
    ...
    public class War : Microsoft.Xna.Framework.Game
    {
        ...
        PreparingDeviceSettingsEventArgs e)
        {
            ...
            {
                if (displayMode.Width == 800/*GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Width*/ && displayMode.Height == 600/*GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Height*/)
                {
