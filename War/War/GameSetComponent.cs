                    ...
                    if (buttons[19].isCollided(mouseStateCurrent.X, mouseStateCurrent.Y))
                    {
                      ...
                      /*
                            if (buttons[0].getNumberOfFrame() == 1)
                                Tabuleiro.jogadores.Add(new Humano(Global.BRANCO));
                            if (buttons[1].getNumberOfFrame() == 1)
                                Tabuleiro.jogadores.Add(new Humano(Global.PRETO));
                            if (buttons[2].getNumberOfFrame() == 1)
                                Tabuleiro.jogadores.Add(new Humano(Global.VERMELHO));
                            if (buttons[3].getNumberOfFrame() == 1)
                                Tabuleiro.jogadores.Add(new Humano(Global.VERDE));
                            if (buttons[4].getNumberOfFrame() == 1)
                                Tabuleiro.jogadores.Add(new Humano(Global.AZUL));
                            if (buttons[5].getNumberOfFrame() == 1)
                                Tabuleiro.jogadores.Add(new Humano(Global.AMARELO));
                      */     
